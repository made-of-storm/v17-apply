...
**SEO:** индексировать нужно `https://v17.vc/apply`, а не копию формы на GitHub Pages.
В `index.html` стоит `noindex` и каноникал на v17.vc/apply. На Тильде у страницы
Apply снимите «Закрыть от индексации» и удалите `Disallow: /apply` из robots.txt.
